...
const Privacy = props => {
  ...
  return (
    <WindoW column={true}>
      <div className="flex column maxw-1000px p-10px">
        <h3 className="headline-3">Privacy Notice</h3>
        <br />
        <p className="body-1">
        ...
        />
        <br />
        <h4 className="headline-4">Information Collection, Use, and Sharing</h4>
        <br />
        <p className="body-1">
